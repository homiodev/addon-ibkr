...
public class IbkrEntity extends MiscEntity implements EntityService<IbkrService>,
    ...
    @SneakyThrows
    @UIContextMenuAction(value = "CREATE_IBKR_WIDGET", icon = "fas fa-icons")
    public ActionResponseModel createWidget(Context context) {
        context.widget().createCustomWidget(getEntityID(), customWidgetBuilder -> customWidgetBuilder
